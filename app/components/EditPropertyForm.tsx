...
const EditPropertyForm = ({ property }: { property: TProperty }) => {
  ...
  const onSubmit = async (data: UpdateProperty) => {
    try {
      setPending(true);
      const result: TProperty = await updateProperty(property._id, data);
